...
<section class="section">
  <div class="section-header d-flex justify-content-between">
    <h1>DAFTAR BUDI-DN REKOMENDASI BEASISWA DOSEN</h1>
        ...
        <div class="card-body">
          ...
          <form action="proses_upload2.php" method="POST" enctype="multipart/form-data">
            <table cellpadding="8" class="w-100">
              ...
              <tr>
               <td>Asal Instansi</td>
               <td><input class="form-control" type="text" name="Instansi" placeholder="Asal Instansi.." required="required"></td>
              </tr>
              <tr>
               <td>Alamat</td>
              ...
              <tr>
               <td>Form Rekomendasi sesuai pedoman BUDI DN </td>
